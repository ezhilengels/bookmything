          ...
          <>
            <div className="md:hidden p-3 space-y-2">
              {bookings.map((b) => {
                ...
                return (
                  <div key={b.id} className="rounded-xl border border-gray-200 shadow-sm p-3 bg-white">
                    ...
                    <div className="mt-2 grid grid-cols-2 gap-2 text-xs">
                      <div className="rounded-lg bg-gray-50 px-2.5 py-2 min-w-0">
                        ...
                        <p className="mt-0.5 text-gray-700 truncate">{service?.name ?? "—"}</p>
                      </div>
                      <div className="rounded-lg bg-gray-50 px-2.5 py-2">
                        <p className="text-[10px] font-semibold tracking-wide text-gray-500 uppercase">Staff</p>
                        <p className="mt-0.5 text-gray-700">{staffMember?.name ?? "—"}</p>
                      </div>
                      <div className="rounded-lg bg-gray-50 px-2.5 py-2">
                        <p className="text-[10px] font-semibold tracking-wide text-gray-500 uppercase">Date & Time</p>
                        <p className="mt-0.5 text-gray-700">{formatDateTime(b.start_time, timezone)}</p>
                      </div>
                      <div className="rounded-lg bg-gray-50 px-2.5 py-2">
                        <p className="text-[10px] font-semibold tracking-wide text-gray-500 uppercase">Amount</p>
                        <p className="mt-0.5 font-medium text-blue-700">{service ? formatCurrency(service.price) : "—"}</p>
                      </div>
                    </div>
